...
CREATE INDEX previous_next_resource_status_stats__prev_id ON public._previous_next_resource_status_stats (prev_id);
CREATE INDEX previous_next_resource_status_stats__next_id ON public._previous_next_resource_status_stats (next_id);
