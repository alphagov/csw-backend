from chalicelib.criteria.aws_ec2_egress_restriction import (
    UnrestrictedEgressSecurityGroups,
)
...
class TestUnrestrictedEgressSecurityGroups(
    ...
    def test_get_data(self):
        ...
        self.subclass.client.describe_security_groups = lambda session: EGRESS_RESTRICTION[
            "fail"
        ][
            "SecurityGroups"
        ]
