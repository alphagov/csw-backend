...
EGRESS_RESTRICTION = {
    'pass': {'ResponseMetadata': {'HTTPHeaders': {'content-type': 'text/xml;charset=UTF-8',
                      ...
                      'RetryAttempts': 0},
 'SecurityGroups': [{'Description': 'csw-rds-test',
                     'GroupId': 'sg-0c01aa0a585fc11a8',
                     'GroupName': 'csw-rds-test',
                     'IpPermissions': [{'FromPort': 3306,
                                        'IpProtocol': 'tcp',
                                        'IpRanges': [{'CidrIp': '213.86.153.237/32',
                                                      'Description': 'csw-rds-test'}],
                                        'Ipv6Ranges': [],
                                        'PrefixListIds': [],
                                        'ToPort': 3306,
                                        'UserIdGroupPairs': []}],
                     'IpPermissionsEgress': [{'FromPort': 80,
                                              'IpProtocol': 'tcp',
                                              'IpRanges': [{'CidrIp': '213.86.153.212/32',
                     ...
                     'VpcId': 'vpc-4dc85b25'}]},
    'fail': {'ResponseMetadata': {'HTTPHeaders': {'content-type': 'text/xml;charset=UTF-8',
 ...
 'SecurityGroups': [{'Description': 'default VPC security group',
                     ...
                     'IpPermissions': [{'IpProtocol': '-1',
                                        ...
                                        'Ipv6Ranges': [],
                                        'PrefixListIds': [],
                                        'UserIdGroupPairs': [{'GroupId': 'sg-eadaa087',
                                                              'UserId': '489877524855'}]}],
